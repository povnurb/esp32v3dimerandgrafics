...
// Zona de alarmas
// ---------------------------------------------------
uint8_t ALRM_PIN1 = 16, ALRM_PIN2 = 17, ALRM_PIN3 = 25, ALRM_PIN4 = 26, ALRM_PIN5 = 27;
bool ALRM_STATUS1, ALRM_STATUS2, ALRM_STATUS3, ALRM_STATUS4, ALRM_STATUS5;
bool ALRM_LOGIC1, ALRM_LOGIC2, ALRM_LOGIC3, ALRM_LOGIC4, ALRM_LOGIC5;
String ALRM_NAME1, ALRM_NAME2, ALRM_NAME3, ALRM_NAME4, ALRM_NAME5;
String ALRM_TON1, ALRM_TON2, ALRM_TON3, ALRM_TON4, ALRM_TON5;
String ALRM_TOFF1, ALRM_TOFF2, ALRM_TOFF3, ALRM_TOFF4, ALRM_TOFF5;
int ALRM_CONT1, ALRM_CONT2, ALRM_CONT3, ALRM_CONT4, ALRM_CONT5;             // registra el valor del contador
int cont[5] = {ALRM_CONT1, ALRM_CONT2, ALRM_CONT3, ALRM_CONT4, ALRM_CONT5}; // lleva la contavilizacion en un for
bool cambiar[5] = {false, false, false, false, false};                      // ayuda al contador a idicar si va a cambiar de numero
...
String OnOffAlarmas()
{
    ...
    jsonDoc["ALRM_CONT1"] = ALRM_CONT1;
    jsonDoc["ALRM_CONT5"] = ALRM_CONT5;
    jsonDoc["ALRM_CONT2"] = ALRM_CONT2;
    jsonDoc["ALRM_CONT3"] = ALRM_CONT3;
...
{ // para provar despues en casa
    ...
    else if (!digitalRead(15) && !normalizar)
    {
        ...
        for (int i = 0; i < 5; i++)
        { // por que antes eran 8 alarmas ahora son 5
            cont[i] = 0;
        }
    }
}
