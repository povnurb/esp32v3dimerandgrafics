...
void handleApiPostWiFi(AsyncWebServerRequest *request, uint8_t *data, size_t len, size_t index, size_t total){
    ...
    // SSID Client
    if (doc["wifi_ssid"] != ""){//si no esta vacia actualizamos la data
    ...
    // Password
    if (doc["wifi_password"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
    ...
    // IPv4
    if (doc["wifi_ipv4"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
    ...
    //Gateway
    if (doc["wifi_gateway"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
    ...
    //Subnet
    if (doc["wifi_subnet"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
    ...
    //DNS Primario
    if (doc["wifi_dns_primary"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
    ...
    //DNS Secundario
    if (doc["wifi_dns_secondary"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
    ...
    //-------------------------------------------------------------------
    //AP SSID
    if (doc["ap_ssid"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
    ...
    //AP Password
    if (doc["ap_password"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
...
void handleApiAlarmas(AsyncWebServerRequest *request){
    ...
    json += ",\"ALRMS\":";
        ...
        json += ",\"ALRM_CONT6\": \"" + String(ALRM_CONT6) + "\"";
        //-------------------------------------------------------------------------------------------
        ...
        json += ",\"ALRM_CONT7\": \"" + String(ALRM_CONT7) + "\"";
        //-------------------------------------------------------------------------------------------
...
void handleApiPostAlarmas(AsyncWebServerRequest *request, uint8_t *data, size_t len, size_t index, size_t total){
    ...
    if (doc["ALRM_NAME1"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_NAME1=doc["ALRM_NAME1"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_TON1"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_TON1=doc["ALRM_TON1"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_TOFF1"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_TOFF1=doc["ALRM_TOFF1"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_CONT1"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
    ...
    if (doc["ALRM_NAME2"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_NAME2=doc["ALRM_NAME2"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_TON2"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_TON2=doc["ALRM_TON2"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_TOFF2"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_TOFF2=doc["ALRM_TOFF2"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_CONT2"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
    ...
    if (doc["ALRM_NAME3"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_NAME3=doc["ALRM_NAME3"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_TON3"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_TON3=doc["ALRM_TON3"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_TOFF3"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_TOFF3=doc["ALRM_TOFF3"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_CONT3"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
    ...
    if (doc["ALRM_NAME4"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_NAME4=doc["ALRM_NAME4"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_TON4"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_TON4=doc["ALRM_TON4"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_TOFF4"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_TOFF4=doc["ALRM_TOFF4"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_CONT4"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
    ...
    if (doc["ALRM_NAME5"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_NAME5=doc["ALRM_NAME5"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_TON5"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_TON5=doc["ALRM_TON5"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_TOFF5"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_TOFF5=doc["ALRM_TOFF5"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_CONT5"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_CONT5=doc["ALRM_CONT5"].as<int>(); //modificamos el valor de la variable con ese valor convertido en String
    }

    ALRM_LOGIC6 = doc["ALRM_LOGIC6"].as<bool>();
    if (doc["ALRM_NAME6"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_NAME6=doc["ALRM_NAME6"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_TON6"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_TON6=doc["ALRM_TON6"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_TOFF6"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_TOFF6=doc["ALRM_TOFF6"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_CONT6"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_CONT6=doc["ALRM_CONT6"].as<int>(); //modificamos el valor de la variable con ese valor convertido en String
    }

    ALRM_LOGIC7 = doc["ALRM_LOGIC7"].as<bool>();
    if (doc["ALRM_NAME7"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_NAME7=doc["ALRM_NAME7"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_TON7"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_TON7=doc["ALRM_TON7"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_TOFF7"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_TOFF7=doc["ALRM_TOFF7"].as<String>(); //modificamos el valor de la variable con ese valor convertido en String
    }
    if (doc["ALRM_CONT7"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
        ALRM_CONT7=doc["ALRM_CONT7"].as<int>(); //modificamos el valor de la variable con ese valor convertido en String
    }
...
void handleApiPostRelays(AsyncWebServerRequest *request, uint8_t *data, size_t len, size_t index, size_t total){
    ...
    if (doc["TIMEOFFRELAY1"] != ""){//si no esta vacia actualizamos la data en caso contrario mantiene su valor
